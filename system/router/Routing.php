...
class Routing{
    ...
    public function run(){
        ...
        if(method_exists($object, $method)){
            $refrelction = new ReflectionMethod($class, $method);
            $parameterCount = $refrelction->getNumberOfParameters();
            $count = count(array_slice($this->current_route,1));
